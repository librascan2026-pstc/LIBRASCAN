...
// FLOW: Login form → Sign In → captcha screen INSIDE same AuthLayout → commitUser → onLoginSuccess(user)
// ⚠️  CAPTCHA IS HANDLED HERE. App.jsx must NOT show a second captcha.
//     onLoginSuccess(user) fires only AFTER captcha passes — App.jsx should call commitUser(user) directly.
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        background: off ? 'rgba(139,0,0,0.35)' : 'linear-gradient(135deg, #8B0000 0%, #6B0000 100%)',
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        fontFamily: FONT_BODY, color: '#b03020', marginBottom: 10, lineHeight: 1.55,
      }}
    >
      {message}
    </motion.div>
        ...
        {screen === 'login' && (
          ...
          >
            ...
            <div style={{ textAlign: 'right', marginBottom: 14, marginTop: -2 }}>
              <LinkBtn onClick={onGoForgot} style={{ fontSize: 12 }}>Forgot Password?</LinkBtn>
            </div>
            ...
            <p style={{ textAlign: 'center', marginTop: 16, fontSize: 13, fontFamily: FONT_BODY, color: '#6a3c1c' }}>
              Don't have an account?{' '}
              <LinkBtn onClick={onGoSignup} style={{ fontSize: 13 }}>Register here</LinkBtn>
            </p>
          </motion.form>
        )}
        ...
        {screen === 'captcha' && (
          ...
          >
            <div style={{
              ...
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8B4513" strokeWidth="2" style={{ flexShrink: 0, marginTop: 2 }}>
